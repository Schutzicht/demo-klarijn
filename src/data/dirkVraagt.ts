...
// Numerieke pravatar IDs (1-70) zijn een vaste curated set volwassen portretten.
// Geen seed-strings (die geven random resultaten incl. minderjarigen).
const px = (id: number) => `https://i.pravatar.cc/240?img=${id}`;
