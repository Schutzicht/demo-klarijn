...
const px = (seed: string) => `https://i.pravatar.cc/200?u=${seed}`;
...
export const klantVragen: DirkVraag[] = [
  ...
  },
  {
    ...
    img: px('klarijn-sandra-schoonheid'),
  },
  {
    who: 'Kees',
    ...
    img: px('klarijn-kees-loonwerker'),
  },
  {
    who: 'Mariska',
    ...
    img: px('klarijn-mariska-webshop'),
  },
];
...
export const franchiseVragen: DirkVraag[] = [
  ...
  },
  {
    ...
    img: px('klarijn-tim-bedrijfsjurist'),
  },
];
