...
export interface ApiDecisionQuestionDecisionQuestion
  extends Struct.CollectionTypeSchema {
...
export interface ApiDirkVraagtDirkVraagt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant: Schema.Attribute.Enumeration<['klant', 'franchise']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'klant'>;
...
export interface ApiRayonRayon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    displayOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rayon.rayon'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
      ['actief', 'pilot', 'beschikbaar', 'voorbereiding']
    > &
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    abonnementPriceMonthly: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<145>;
    companyDescription: Schema.Attribute.Text;
    companySlogan: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Vraag het Klarijn'>;
    contactEmailBestelling: Schema.Attribute.Email &
      Schema.Attribute.DefaultTo<'bestelling@klarijn.nl'>;
    contactEmailMain: Schema.Attribute.Email &
      Schema.Attribute.DefaultTo<'vraaghet@klarijn.nl'>;
    contactPhonePrimary: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'06-51180138'>;
    contactPhoneSecondary: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'06-10903140'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    mijnVoortgangUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::decision-question.decision-question': ApiDecisionQuestionDecisionQuestion;
